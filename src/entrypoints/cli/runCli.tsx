...
async function parseArgs(
  ...
  const pluginMarketplaceCmd = pluginCmd
    .command('marketplace')
    .description(
      'Manage marketplaces (.claude-paper-plugin/marketplace.json; legacy .claude-plugin supported)',
    )
  ...
  const marketplaceCmd = skillsCmd
    .command('marketplace')
    .description(
      'Manage skill marketplaces (.claude-paper-plugin/marketplace.json; legacy .claude-plugin supported)',
    )
  ...
  skillsCmd
    ...
    .option(
      '--project',
      'Install into this project (.claude-paper/...)',
      () => true,
    )
    .option('--force', 'Overwrite existing installed files', () => true)
    .action(async (plugin: string, options: any) => {
  ...
  skillsCmd
    ...
    .option(
      '--project',
      'Uninstall from this project (.claude-paper/...)',
      () => true,
    )
    .action(async (plugin: string, options: any) => {
      try {
